...
// add new address popup
  ...
  const handleSaveAddress = async (e) => {
    ...
    //   if (responseData.result && responseData.result.length > 0) {
    //     const address = responseData.result[0];

    //     if (selectedAddressId) {
    //       // Update the address in the getAddress list
    //       setGetAddress((prevAddresses) =>
    //         prevAddresses.map((addr) =>
    //           addr.addressId === selectedAddressId ? address : addr
    //         )
    //       );
    //     } else {
    //       // Add the new address to the list
    //       setGetAddress((prevAddresses) => [...prevAddresses, address]);
    //     }

    //   }
    // } catch (error) {
    //   console.error(`Error ${selectedAddressId ? 'updating' : 'adding'} address:`, error);
    // }
  ...
  // const [newAddressForm, setNewAddressForm] = useState(() => {
  //   const savedForm = localStorage.getItem('newAddressForm');
  //   return savedForm
  ...
  // const handleChangeForm = (e) => {
    ...
    // // Log the input name and value to ensure it's being captured
  ...
  // };
    ...
    // const address = useSelector((state) => state.address1.address);
    // const state = useSelector((state) => state);
    // console.log("Full State:", state);
    // console.log("adree-->", address)
  // const dispatch = useDispatch()
  // const handleAddAddress = () => {
  //   dispatch(addAddress(newAddressForm))
  //   setNewAddressForm({
  //     First_Name: '', Phone_Number: '', Address: '', Town_City
  //       : '', States: '', Pin_Code: '', Bussiness_phone: ''
  //     })
...
//     try {
//     //   await fetchAddAddressApi(payLaodNewForm);
//     // } catch (error) {
//     //   console.error("There was a problem with the fetch operation:", error);
//     //   throw error;
//     // }
...
//         // fetchGetFormData();
//         fetchGetFormData(responseData.result)
//         //       // setProductData(response)
...
//   //   }
  ...
  //   const payLaodNewForm = {
  //     addressId: "0",
  //     customerId: "dummyUserId", // Assuming you are using dummy data for now
  //     firstName: newAddressForm.First_Name,
  //     middleName: null,
  //     lastName: null,
  //     phoneNumber: newAddressForm.Phone_Number,
  ...
  //       setGetAddress((prevAddresses) => [...prevAddresses, newAddress]);
  ...
  //   try {
  //     const response = await fetch(`http://ec2-100-29-38-82.compute-1.amazonaws.com:5000/api/Customer/Address/GetById?addressId=${addressId}`, {
  //       method: "GET",
  //     });
  ...
  //     setGetAddress((prevAddresses) => {
  //       const addressExists = prevAddresses.some(address => address.addressId === result.result.addressId);

  //       if (addressExists) {
  //         return prevAddresses.map(address =>
  //           address.addressId === result.result.addressId ? result.result : address
  //         );
  //       } else {
  //         return [...prevAddresses, result.result];
  //       }
  //     });
  //   } catch (error) {
  //     console.error("Error fetching address details:", error);
  ...
  // Example: Fetch an address when the component mounts or based on some event
  // useEffect(() => {
  //   const addressId = 'example-address-id'; // Replace with actual address ID
  //   fetchGetFormData(addressId);
  // }, []);
  ...
  //     try {
  //       const response = await axios.get('/api/Customer/Address/GetById?addressId=123');
  //       dispatch(setAddress(response.data.result)); // Dispatching to store
  //     } catch (error) {
  ...
  //       Phone_Number: newAddressData.phoneNumber || '',
  //       Pin_Code: newAddressData.pincode || '',
  //       Address: newAddressData.address1 || '',
  //       Town_City: newAddressData.city || '',
  //       States: newAddressData.state || ''
  //     });
  //   }
  // }, [newAddressData]);

  // useEffect(() => {
  //   localStorage.setItem('newAddressForm', JSON.stringify(newAddressForm));
  // }, [newAddressForm]);
  ...
  //   const savedForm = localStorage.getItem('newAddressForm');
  //   if (savedForm) {
  //     setNewAddressForm(JSON.parse(savedForm));
  //   }
  // }, []);
  // useEffect(() => {
  ...
  //     localStorage.setItem('addresses', JSON.stringify(getAddress));
  //   }
  // }, [getAddress])
                  ...
                  <p className="text-sm text-cyan-500">Edit Address</p>
                          ...
                          <div className="flex">
                            ...
                            <div className="flex items-center justify-center text-base">
                              ...
                              <p>{item.state},</p>
                              <p>{item.phoneNumber},</p>
                              {/* <p className="mx-1">{item.Country},</p> */}
                              {/* <p>{item.pincode},</p> */}
                              {/* <p className="mx-1">{details[0].email},</p> */}

                              {/* <p>{details[0].Bussiness_phone}</p> */}

                                  {/* <div className="flex hover:underline hover:text-red-500 cursor-pointer ml-2" onClick={handleEditAddress(item.addressId, item)}>
                                <p className="text-sm text-cyan-500">Edit</p>
                                <p className="text-sm text-cyan-500">Address</p>
                              </div>
                                </div>
