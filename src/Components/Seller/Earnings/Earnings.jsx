...
//         </div>
//         <div className="flex">
//         <div className=" flex  flex-col my-4 flex-wrap justify-normal gap-2 items-center p-4">
//           {stats.map((stat, index) => (
//             <div
//               key={index}
//               className="p-4 h-24 w-56  border rounded-lg shadow-lg flex justify-between items-center bg-white"
//             >
...
//           ))}
//         </div>
//         <div className=" flex w-[70%] justify-between p-2 ">
