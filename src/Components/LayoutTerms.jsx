...
const LayoutTerms =({ topMargin, setActiveStep }) => {
    // return (
    //     <div
    ...
    //             <h1 className=' text-xl md:text-3xl font-medium mt-5 md:mt-0 text-blue-900 text-start py-6 underline'>
    //                 Terms & Conditions
    //             </h1>
    ...
    //             <div>
    //                 <img src={mobile} className=' w-40 h-80 md:w-60 md:h-96 ml-20 md:ml-0' />
    //             </div>
    //             <div className='flex flex-col items-center justify-center '>
    //                 <h1 className='flex  text-xl'>Download App for Free</h1>
    //                 <div className=' flex py-6'>

    //                     <button className='bg-blue text-white mx-6 w-32 h-8 rounded-md flex items-center p-2'>
    ...
    return (
        <div
            ...
            <div className='flex justify-center items-center w-full flex-col'>
                <div className='w-[80%] px-0 md:px-20 py-2 h-full border-b '>
                    <h1 className=' text-xl md:text-3xl font-medium text-blue2 text-center py-6 underline'>
                    ...
                    <h1 className=' text-xl md:text-3xl font-medium text-blue2 text-start py-6 underline'>
                        User Agreement
                    </h1>
                    ...
                    <div className='py-4'>
                        ...
                        <div className='py-2'>
                            ...
                            <div className='py-4'>
                                ...
                                <div className='py-2'>
                                    {/* <a href='/' className='text-blue-900 underline'>www.pharmetrade.com</a> {" "} */}
                                    <strong><p>A seller can cancel an order if:</p> </strong><br />
                                ...
                                <div className='py-4'>
                                    ...
                                    <div className='py-2'>
                                        ...
                                        <ul className=" space-y-2" >
                                            ...
                                            &nbsp;<strong>i &nbsp; Consent:</strong> &nbsp; By clicking the "I Agree" button below, you consent to receive notices solely in electronic format from PharmEtrade. Please regularly check Rxeed.com for updates to notices. PharmEtrade will post any changes in hardware or software requirements needed to access the notices.<br />
                                            &nbsp;<strong>ii &nbsp; Delivery Considerations: &nbsp;</strong> To access Rxeed.com, you must have access to a personal computer with appropriate and compatible browser software and access to the Internet. To print and save notices, you must have access to a printer.<br />
                                            &nbsp;<strong>iii &nbsp; Duration and Withdrawal of Consent: &nbsp;</strong> Your consent will be effective indefinitely. We reserve the right to send you paper copies of any documents or notices that you have consented to receive electronically or that are not available electronically and to discontinue sending updated notices electronically to you at any time.<br />
