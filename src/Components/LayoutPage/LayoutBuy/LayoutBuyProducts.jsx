...
//                         <div className="flex sm:flex-col flex-row sm:justify-between justify-start gap-2 sm:mx-3 mx-0 text-right">
//                           <div className="flex  flex-row sm:flex-col gap-2 sm:mx-3 mx-0  text-right layoutBuyProducts-units">
...
//                         <div className="flex sm:flex-col layoutBuyProducts-units   gap-2 flex-row sm:mx-3 mx-0 text-right">
...
//                         <div className="flex  flex-row sm:flex-col gap-2 sm:mx-3 mx-0  text-right ">
...
//                           <div className="flex sm:justify-center align-middle mt-4">
//                             <div>
//                               <Tooltip title="Wishlist" placement="top">
//                                 <img
//                                   src={
