...
//   setQuantities,
// }) {
//   const [stockWarning, setStockWarning] = useState({ productId: null, message: "" });
//   const navigate = useNavigate();
//   const [productLink, setProductLink] = useState("");
//   const [currentProductID, setCurrentProductID] = useState("");
//   const [itemsPerPage, setItemsPerPage] = useState(10); // Set initial items per page
...
//                         </div>
//                         <p className="mt-1">Product returnable: {product.returnable ? 'Yes'  : 'NA'}</p>
//                       </div>
//                     </div>
...
//                           className="px-2 py-1 border rounded-md bg-gray-200 text-gray-700 font-bold"
//                           onClick={() => {
//                             if (product.CartQuantity + 1 > product.amountInStock) {
...
//                               });
//                             } else {
//                               handleQuantityChange(index, product.CartQuantity + 1);
...
//                       </div>
//                       {/* Display the stock message only for the clicked product */}
//                       {stockWarning.productId === product.productID && (
//                         <p className="text-red-500 text-sm mt-2">{stockWarning.message}</p>
//                       )}
//                     </div>
