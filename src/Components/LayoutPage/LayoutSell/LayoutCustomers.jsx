                    ...
                    <td className="px-4 py-2 flex items-center space-x-2 justify-center">
                      <Tooltip title="Edit" placement="top">
                        <img
                          src={edit}
                          alt="Edit"
                          className={`cursor-pointer w-7 h-7 ${deletedCustomers.includes(customer.name) ||
                      ...
                      <Tooltip title="Delete" placement="top">
                        <img
                          src={Bin}
                          alt="Delete"
                          className={`cursor-pointer w-5 h-5 ${deletedCustomers.includes(customer.name) ||
                              deactivatedCustomers.includes(customer.name)
                              ? "opacity-50 pointer-events-none"
                              : ""
                            }`}
                      ...
                      <Tooltip title="Deactivate" placement="top">
                        <img
                          src={Deactivate}
                          alt="Deactivate"
                          className={`cursor-pointer w-4 h-4 ${deletedCustomers.includes(customer.name) ||
                              deactivatedCustomers.includes(customer.name)
                              ? "opacity-50 pointer-events-none"
                              : ""
                            }`}
