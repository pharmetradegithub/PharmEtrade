  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: ({ row }) => {
        ...
        return format(createdOn, "MM/dd/yyyy");
      },
    },
    {
      name: "Actual Cost",
      renderHeaderCell: () => {
        return <div className="flex justify-center w-full">Actual Cost</div>;
      },
      children: [
        {
          key: "unitPrice",
    ...
    },
    {
      ...
      renderHeaderCell: () => {
        return (
          <div className="flex justify-center w-full">Sale Information</div>
        );
      },
      children: [
        {
          key: "salePriceValidFrom",
          name: "Sale starts",
          renderCell: ({ row }) => {
            console.log("from cell", row.salePriceValidFrom);
            return format(row.salePriceValidFrom, "MM/dd/yyyy");
          },
        },
        {
          key: "salePriceValidTo",
          name: "Sale ends",
          renderCell: ({ row }) => {
            return format(row.salePriceValidFrom, "MM/dd/yyyy");
          },
    ...
    },
    {
      name: "Receivables",
      renderHeaderCell: () => {
        return <div className="flex justify-center w-full">Receivables</div>;
      },
      children: [
        {
          key: "receivableUnitPrice",
          name: "Unit Price",
        },
        {
          key: "receivableUPNMemberPrice",
          name: "UPN Member Price",
        },
        {
          key: "receivableSalePrice",
          name: "Sale Price",
        },
      ],
    },
      ...
      <div className="w-[95%] h-full mt-4 ">
        ...
        <div className="w-full overflow-scroll">
          <div className="text-[15px] mt-4">
            ...
            {/* !TODO: Implement data grid component and replace the below code */}
            {!loading && !error && (
            ...
            {/* !TODO: Implement data grid component and replace the above code */}
