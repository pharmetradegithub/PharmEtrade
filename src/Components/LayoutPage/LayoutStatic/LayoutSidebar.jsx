...
function LayoutSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`p-2 overflow-scroll h-full z-[100] font-normal font-sans flex flex-col shadow-lg fixed top-0 left-0 transform lg:transform-none lg:translate-x-0 ${isMobileOpen ? "translate-x-0" : "-translate-x-full"
          } transition-transform duration-300 lg:block ${isCollapsed ? "min-w-16 items-center" : "min-w-64"} w-64 max-w-full`}
            ...
            <div key={index}>
              {item.children ? (
                ...
                <Link
                  ...
                  className={`flex items-center font-semibold text-[15px] p-2 ${activeLink === item.to
                    ...
                    <li key={idx}>
                      {child.children ? (
                              ...
                              {child.children.map((subChild, subIdx) => (
                                <li key={subIdx}>
                                  <Link
                                    ...
                                    className={`flex items-center font-normal text-[15px] p-2 ${activeLink === subChild.to
                                        ? "text-white bg-gray-400"
                                        : "text-white"
                                      } hover:text-white hover:bg-gray-400`}
                                  >
                        ...
                        <Link
                          ...
                          className={`flex items-center font-normal text-[15px] p-2 ${activeLink === child.to
                              ? "text-white bg-gray-400"
                              : "text-white"
                            } hover:text-white hover:bg-gray-400`}
                        >
