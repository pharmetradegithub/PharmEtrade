...
//                 <h1 className='text-xl text-blue-900 font-semibold mt-4'>Received Orders</h1>
...
const LayoutBuyerReceiversgrid = () => {
        ...
        const fetchOrders = async () => {
            ...
            try {
                ...
                const filteredOrders = res
                    .filter((Ordergrid) => Ordergrid.orderedProductStatusId === 6) // Only include orders with orderStatusId = 5
    ...
    return (
        <div className='w-full h-[80vh] mt-4 overflow-y-auto'>
            <div className='flex flex-col mx-5'>
                <div className='flex justify-between'>
                    <h1 className='text-xl text-blue2 font-semibold mt-4'>Received Orders</h1>
                    {/* <div className="relative flex mb-9">
                        <input
                            type="text"
                            placeholder="Search Product....."
