...
const TotalProducts = () => {
  ...
  const handleEditProduct = (detail) => {
    navigate(
      `/pharmEtradeadmin/EditProductAdmin?productId=${detail.productID}`
    );
  };
      ...
      <div className="bg-gray-100 w-full h-full flex overflow-y-scroll items-center justify-center">
              ...
              <table className="w-full text-sm">
                <thead className="bg-blue text-white  ">
                  <tr className="border-b-2 text-left ">
                    ...
                    <th className="py-2 px-5" onClick={() => handleSort("")}>
                      Thumbnail
                    </th>
                    ...
                    <th
                      className="py-2 px-2"
                      onClick={() => handleSort("sellerFirstName")}
                    >
                      Seller Name
                    ...
                    <th
                      className="py-2 px-4"
                      onClick={() => handleSort("salePriceValidFrom")}
                    >
                      Saleprice Start
                    ...
                    <th
                      className="py-2 px-4"
                      onClick={() => handleSort("salePriceValidTo")}
                    >
                      Saleprice End
        ...
        <Tooltip title="Activate" placement="top">
          <img
            ...
            alt="Activate"
            className="cursor-pointer w-4 h-4"
            onClick={() => activatePopUp(detail?.productID)}
          />
        </Tooltip>
      )}
