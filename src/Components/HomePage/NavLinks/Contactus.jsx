    ...
    >
      ...
      <div className="w-full h-full flex flex-col items-center ">
        <div className="my-4 flex">
          <h1 className="text-3xl text-center text-blue-900 font-semibold my-4">
            Contact Us
          </h1>
        </div>

        {submitted && (
          <p className="fixed top-4 right-4 p-2 px-2 rounded-md text-white bg-blue-900 font-semibold mt-4">
        ...
        <div className="flex  my-4 w-[90%] justify-around ">
          {/* Location */}
          <div
            className="flex items-center gap-3 bg-white rounded-md p-1 w-[30%] justify-center"
            onClick={handleOpenMap}
          >
            <div>
              <img src={location} className="h-11 w-12" alt="Location" />
            </div>
            <div className="flex-col flex">
              <h1 className="text-xl text-blue-900 font-semibold">Location</h1>
              <p className="text-base text-black flex flex-wrap hover:text-red-600 hover:underline">
          ...
          <div className="flex items-center gap-3 rounded-md bg-white p-1 w-[30%] justify-center">
            <div>
              <img src={call} className="h-11 w-10" alt="Phone" />
            </div>
          ...
          <div className="flex items-center gap-3 rounded-md bg-white p-1 w-[30%] justify-center">
            <div>
              <img src={mail} className="h-9 w-8" alt="Mail" />
            </div>
        ...
        <div className="flex w-[90%]  justify-between ">
          <div className="w-[45%] p-6 m-4 flex bg-white h-[520px] flex-col gap-6 shadow-md rounded-md">
            <h2 className="text-2xl text-start flex justify-between items-center ml-4 text-blue-900 font-semibold ">
              Send Message
            </h2>
