...
const RequestDemo = ({ topMargin }) => {
  ...
  return (
    <div
      ...
      style={{ marginTop: `${topMargin}px` }}
    >
<div className="absolute top-0 w-full h-full sm:h-[60vh] md:h-[75vh] lg:h-screen z-[-1] flex justify-center items-center">
<img className="w-full   h-full opacity-50" src={background_image} alt="Background" />
      </div>

      <div className="w-full h-screen flex flex-col sm:flex-col md:flex-row lg:flex-row items-center">
      <div className="w-full sm:w-full md:w-[54%] lg:w-[54%] p-10 md:p-20 m-4 flex flex-col gap-6">
      <h1 className='text-4xl sm:text-5xl lg:text-6xl text-black font-semibold'>Unlock Your Marketplace Potential with a Live Demo</h1>
          <p className='text-black text-lg sm:text-xl font-medium'>See how our platform can elevate your buying and selling experience. 
            Join our live demo to explore powerful features designed for your success.</p>
        </div>
