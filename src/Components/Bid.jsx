...
// const Bid = ({ topMargin }) => {
//   return (
//     <div className=' w-full h-full flex justify-center items-center '  style={{marginTop: `${topMargin}px`}}>
//       <div className='w-[95%] h-full '>
//         <h2 className='text-2xl'>Request For Quote</h2>
//       </div>
//     </div>
//   )
// }
...
import { fetchCustomer } from "../Api/BidApi";
