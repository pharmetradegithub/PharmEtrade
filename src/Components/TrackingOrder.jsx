    ...
    <div className="flex flex-col w-full py-8 overflow-y-scroll">
      <div className="w-[85%]">
        ...
        <div className="flex justify-around sm:flex-row flex-col">
            ...
            {orderStatus.map((status, index) => (
              <div key={index} className="flex flex-col ">
                ...
                <div className="flex">
                  ...
                  ${
                    index <= Math.floor(currentStatus)
                      ? "bg-green-500 z-20 text-white"
                      : "bg-gray-300 z-20 text-gray-600"
                  }`}
                  >
                    <status.icon />
                  </div>
          ...
          <div className="flex flex-col ml-5 sm:ml-0">
            ...
            <div className="border rounded-md h-auto p-4 shadow-md ml-2 mt-4 sm:w-80 w-full items-center flex flex-col">
              <h1 className="font-semibold text-xl">Order Info</h1>
              <h1 className="text-blue-700 text-xl hover:underline">
                <Link to="/layout/layoutorderlist">View Order Details</Link>
              </h1>
