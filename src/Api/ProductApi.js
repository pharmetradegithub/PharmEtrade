...
//       store.dispatch({type:'product/setRelatedProduct',payload:relatedProduct});
...
//       store.dispatch({ type: 'product/setUpSellProduct', payload: upsellProducts });
...
//       store.dispatch({ type: 'product/setCrossSellProduct', payload: crossSellProducts });
